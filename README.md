...
* [Induction/Induction](https://github.com/Induction/Induction) - A Polyglot Database Client for Mac OS X
...
* [MugunthKumar/MKNetworkKit](https://github.com/MugunthKumar/MKNetworkKit) - ARC ready Networking Framework with built in authentication and HTTP 1.1 caching standards support for iOS 5+ devices
...
* [CoderMJLee/MJExtension](https://github.com/CoderMJLee/MJExtension) - The fastest, most convenient and most nonintrusive conversion between JSON and model. Your model class don't need to extend another base class. You don't need to modify any model file.
...
* [alikaragoz/MCSwipeTableViewCell](https://github.com/alikaragoz/MCSwipeTableViewCell) - Convenient UITableViewCell subclass that implements a swippable content to trigger actions (similar to the Mailbox app).
...
* [timburks/nu](https://github.com/timburks/nu) - The Nu programming language.
...
* [MugunthKumar/MKStoreKit](https://github.com/MugunthKumar/MKStoreKit) - The "Goto" In App Purchases Framework for iOS 7+
...
* [bang590/JSPatch](https://github.com/bang590/JSPatch) - JSPatch bridge Objective-C and JavaScript using the Objective-C runtime. You can call any Objective-C class and method in JavaScript by just including a small engine.
...
* [shadowsocks/shadowsocks-iOS](https://github.com/shadowsocks/shadowsocks-iOS) - shadowsocks client for OSX and non-jailbroken iOS
...
* [krzysztofzablocki/KZPlayground](https://github.com/krzysztofzablocki/KZPlayground) - Playgrounds for Objective-C
...
* [mariohahn/MHVideoPhotoGallery](https://github.com/mariohahn/MHVideoPhotoGallery) - A Photo and Video Gallery designed for iOS 7 and iOS 8
...
* [scalessec/Toast](https://github.com/scalessec/Toast) - An Objective-C category that adds Android-style toast notifications to iOS.
* [JonasGessner/JGProgressHUD](https://github.com/JonasGessner/JGProgressHUD) - Powerful, simple and modern progress HUD for iOS. This ProgressHUD supports iOS 5 - iOS 8.
...
* [piemonte/PBJVision](https://github.com/piemonte/PBJVision) - iOS camera engine, features touch-to-record video, slow motion video, and photo capture
...
* [KittenYang/KYGooeyMenu](https://github.com/KittenYang/KYGooeyMenu) - A not bad gooey fffects menu.
...
* [Draveness/DKNightVersion](https://github.com/Draveness/DKNightVersion) - DKNightVersion is a lightweight iOS framework adding night mode/theme to your iOS app.
* [kolinkrewinkel/Polychromatic](https://github.com/kolinkrewinkel/Polychromatic) - Coloring with significance.
* [comyarzaheri/Sol](https://github.com/comyarzaheri/Sol) - Sol° beautifully displays weather information so you can plan your day accordingly. Check the weather in your current location or any city around the world. Implemented in Objective-C.
...
* [alvises/FPPopover](https://github.com/alvises/FPPopover) - (NOT maintained anymore) FPPopover provides an alternative to the native iOS UIPopoverController, adding support for iPhone and additional opportunities to customize the look and feel of the popovers.
...
* [kolinkrewinkel/KKGridView](https://github.com/kolinkrewinkel/KKGridView) - Deprecated: See the readme for more info. — Gridview for iOS.
...
* [kean/DFImageManager](https://github.com/kean/DFImageManager) - Advanced iOS framework for loading images. Delivers consistency, extensibility, and performance.
...
* [ChenYilong/iOS9AdaptationTips](https://github.com/ChenYilong/iOS9AdaptationTips) - iOS9适配系列教程
...
* [ZhongTaoTian/WNXHuntForCity](https://github.com/ZhongTaoTian/WNXHuntForCity) - 高仿城觅2.0 by-objective-c
...
* [Overcoat/Overcoat](https://github.com/Overcoat/Overcoat) - The perfect accessory for Mantle.
...
* [ruslanskorb/RSKImageCropper](https://github.com/ruslanskorb/RSKImageCropper) - An image cropper for iOS like in the Contacts app with support for landscape orientation.
...
* [alikaragoz/AKTabBarController](https://github.com/alikaragoz/AKTabBarController) - Deprecated - This project is not maintained anymore.
...
* [gontovnik/DGActivityIndicatorView](https://github.com/gontovnik/DGActivityIndicatorView) - DGActivityIndicatorView is a great way to make loading spinners in your application look nicer. It contains 6 different indicator view styles.
...
* [relatedcode/RealtimeChat](https://github.com/relatedcode/RealtimeChat) - This is a full native iPhone app to create realtime, text based group or private chat with Parse and Firebase.
...
* [datwelk/RDRStickyKeyboardView](https://github.com/datwelk/RDRStickyKeyboardView) - Replication of iMessage's text input behavior on iOS 7 (UIScrollViewKeyboardDismissModeInteractive + persistent inputAccessoryView)
...
* [mdiep/MMMarkdown](https://github.com/mdiep/MMMarkdown) - An Objective-C static library for converting Markdown to HTML.
...
* [mmackh/Hacker-News-for-iOS](https://github.com/mmackh/Hacker-News-for-iOS) - Hacker News client for iPad and iPhone
...
* [kimsungwhee/KSHObjcUML](https://github.com/kimsungwhee/KSHObjcUML) - KSHObjcUML can show oriented graph of dependencies between Objective-C classes in your project
...
* [arielelkin/PocketSVG](https://github.com/arielelkin/PocketSVG) - Easily convert your SVG files into CGPaths, CAShapeLayers, and UIBezierCurves.
...
* [LeoNatan/LNNotificationsUI](https://github.com/LeoNatan/LNNotificationsUI) - A framework for displaying notifications similar to Apple's iOS 7 and iOS 8 notifications.
...
* [erichoracek/Motif](https://github.com/erichoracek/Motif) - A lightweight and customizable stylesheet framework for iOS
...
* [shu223/UIActivityCollection](https://github.com/shu223/UIActivityCollection) - A collection of iOS6 UIActivity providers.
