...
* [liangdahong/BMLongPressDragCellCollectionView](https://github.com/liangdahong/BMLongPressDragCellCollectionView) - 🎉 让你轻松实现类似支付宝的拖拽重排功能, 支持各种自定义,  iOS8+ , 基于 UICollectionView 实现。
