...
* [CoderMikeHe/WeChat](https://github.com/CoderMikeHe/WeChat) - 🔥🔥🔥 iOS 利用MVVM + RAC + ViewModel-Based Navigation来搭建微信(WeChat 7.0.0+)的整体基本架构，以及实现微信朋友圈、通讯录、搜索等主要功能，代码规范惊为天人、注释详解令人发指、细节处理精益求精、核心功能配备文档、接近98%还原度的原生App视觉体验，代码不多，注释多。（持续更新，敬请期待，欢迎Star和Fork…）
...
* [CoderLN/Apple-GitHub-Codeidea](https://github.com/CoderLN/Apple-GitHub-Codeidea) - 三方源码，随 (大版本) 迭代分析
...
* [CoderLN/Framework-Codeidea](https://github.com/CoderLN/Framework-Codeidea) - 系统框架，文件归类
